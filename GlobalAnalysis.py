...
AllPatients = pd.read_csv(r"/Users/Tom/Documents/University/ProstateCode/AllData19Frac.csv")
...
fig, ax = plt.subplots()
ax.scatter(PatientsWhoRecur["volumeContour"], PatientsWhoRecur["volumeContourAuto"],c='r',label='recurr')
ax.scatter(PatientsWhoDontRecur["volumeContour"], PatientsWhoDontRecur["volumeContourAuto",c='b'],label='non-recurr')
plt.plot(FilteredPatients["volumeContour"],FilteredPatients["volumeContourAuto"], 'yo', FilteredPatients["volumeContour"], fit_fn(FilteredPatients["volumeContour"]), '--k')
...
plt.legend(loc='upper left')
fig1.savefig('/Users/Tom/Documents/University/ProstateCode/DiceCoeff.png')
plt.show()
...
fig2.savefig('/Users/Tom/Documents/University/ProstateCode/GlobalVolDiff.png')
plt.show()
